  ...
  (above/align "center"
               (beside
                ...
                (flip-horizontal
                 (rotate 135 (ellipse 15 5 "outline" "gold"))))
               (underlay
                (underlay (rectangle 40 35 "solid" (color color1 color2 color3))(rectangle 3 35 "solid" "gold"))
...
(define (starlit-sky star-amount scene)
  (if (= star-amount 1)
      ...
      (underlay (place-image (rotate (+ 1 (random 359)) (scale (/ (+ (random 99) 1) 100)
                                                               outlined-star)) (+ (random 450) 25) (+ 30 (random 120)) scene) (starlit-sky (- star-amount 1) scene))))
...
(define create-picture (underlay
                        ...
                        (place-image (present-stack 3) 300 240 transparent-scene)))
